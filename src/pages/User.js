  ...
  return (
    <>
        <div className='w-full mx-auto lg:w-10/12'>
            <div className='mb-4'>
                <Link to="/github_finder" className='btn btn-ghost'> Back to Search</Link>
            </div>
            ...
            <div className='grid grid-cols-1 xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-3 mb-8 md:gap-8'>
                ...
                <div className='col-span-2'>
                    <div className='mb-6'>
                        ...
                        <div className='ml-2 badge badge-success'>{type}
                        </div>
                        {hireable && (
            ...
            <div className='w-full py-5 mb-6 rounded-lg shadow-md bg-base-100 stats'>
                <div className='stat'>
                    ...
                    <div className='stat-value pr-5 text-3xl md:text:4'>{followers}</div>
                </div>
                ...
                <div className='stat'>
                    ...
                    <div className='stat-value pr-5 text-3xl md:text:4'>{following}</div>
                </div>
                ...
                <div className='stat'>
                    ...
                    <div className='stat-value pr-5 text-3xl md:text:4'>{public_repos}</div>
                </div>
                ...
                <div className='stat'>
                    ...
                    <div className='stat-value pr-5 text-3xl md:text:4'>{public_gists}</div>
                </div>
            </div>
